export default {
  40301: () => $gettext('Secure Gateway UI already installed'),
  ...
  40307: () => $gettext('SSL certificate file must be under Secure Gateway configuration directory: {0}'),
  40308: () => $gettext('SSL key file must be under Secure Gateway configuration directory: {0}'),
}
