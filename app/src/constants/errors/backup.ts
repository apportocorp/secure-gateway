export default {
  ...
  4004: () => $gettext('Failed to backup Secure Gateway UI files: {0}'),
  4005: () => $gettext('Failed to backup Secure Gateway config files: {0}'),
  4006: () => $gettext('Failed to create hash info file: {0}'),
  4007: () => $gettext('Failed to encrypt Secure Gateway UI directory: {0}'),
  4008: () => $gettext('Failed to encrypt Secure Gateway directory: {0}'),
  ...
  4106: () => $gettext('Secure Gateway config directory is not set'),
  4107: () => $gettext('Failed to copy Secure Gateway config directory: {0}'),
  ...
  4506: () => $gettext('Failed to decrypt Secure Gateway UI directory: {0}'),
  4507: () => $gettext('Failed to decrypt Secure Gateway directory: {0}'),
  4508: () => $gettext('Failed to verify hashes: {0}'),
  4509: () => $gettext('Failed to restore Secure Gateway configs: {0}'),
  4510: () => $gettext('Failed to restore Secure Gateway UI files: {0}'),
  ...
  4802: () => $gettext('Failed to calculate Secure Gateway UI hash: {0}'),
  4803: () => $gettext('Failed to calculate Secure Gateway hash: {0}'),
