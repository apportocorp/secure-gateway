          ...
          <template #description>
            ...
            <p>
              {{ $gettext('To ensure security, Webauthn configuration cannot be added through the UI. '
                + 'Please manually configure the following in the app.ini configuration file and restart Secure Gateway UI.') }}
            </p>
            <pre>[webauthn]
# This is the display name
RPDisplayName = Secure Gateway UI
# The domain name of Secure Gateway UI
RPID          = localhost
